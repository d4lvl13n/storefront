...
const faqItems = [
	{
		...
		a: "All peptides are verified at ≥99% purity via High-Performance Liquid Chromatography (HPLC). Every batch is independently tested at accredited US laboratories, and Certificates of Analysis documenting purity, identity, and endotoxin levels are provided with every order.",
	},
	{
