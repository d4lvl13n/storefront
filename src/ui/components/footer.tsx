			...
			<div className="mx-auto max-w-7xl px-4 pb-24 pt-12 sm:px-6 sm:pb-12 lg:px-8 lg:py-16">
				<div className="grid grid-cols-2 gap-8 md:grid-cols-4 lg:gap-12">
					...
					{menuItems.length === 0 && (
						<>
							...
							<div>
								<h4 className="mb-4 text-sm font-medium text-neutral-300">Tools</h4>
								<ul className="space-y-3">
								...
								<h4 className="mb-4 mt-8 text-sm font-medium text-neutral-300">Legal</h4>
								<ul className="space-y-3">
				...
				<div className="mt-12 border-t border-neutral-800 pt-8">
					...
					<div className="mb-6 flex flex-wrap items-center gap-3">
						<span className="text-xs text-neutral-600">Accepted payments:</span>
						{/* Visa */}
						<div className="flex h-7 items-center rounded border border-neutral-800 bg-neutral-900 px-2">
							<svg viewBox="0 0 48 16" className="h-4 w-auto fill-neutral-300">
						...
						{/* Crypto */}
						<div className="flex h-7 items-center gap-1.5 rounded border border-neutral-800 bg-neutral-900 px-2">
							...
							<span className="text-[10px] font-medium text-neutral-400">Crypto</span>
						</div>
						{/* Bank Transfer */}
						<div className="flex h-7 items-center gap-1.5 rounded border border-neutral-800 bg-neutral-900 px-2">
							<svg
							...
							<span className="text-[10px] font-medium text-neutral-400">Wire</span>
						</div>
					</div>
