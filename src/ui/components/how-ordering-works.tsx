...
function CoaBg() {
	...
	return (
		<div className="pointer-events-none absolute inset-0 overflow-hidden rounded-[inherit]">
			...
			<div className="absolute inset-x-5 bottom-5 top-12 rounded-2xl border border-white/5 bg-black/20 p-4">
		...
		<div className="pointer-events-none absolute inset-0 overflow-hidden rounded-[inherit]">
			...
			<div className="absolute inset-x-5 bottom-5 top-12 rounded-2xl border border-white/5 bg-black/20 p-4">
				<div className="flex h-full flex-col justify-between gap-3">
					...
					<div className="flex items-center gap-3 rounded-xl border border-white/5 bg-black/30 px-3 py-3">
						<div
...
function ShippingBg() {
	return (
		<div className="pointer-events-none absolute inset-0 overflow-hidden rounded-[inherit]">
			...
			<div className="absolute inset-x-5 bottom-5 top-12 rounded-2xl border border-white/5 bg-black/20 px-4 py-5">
